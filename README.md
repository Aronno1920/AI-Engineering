...
# স্টাডি প্ল্যান | ১৯ টি মডিউল

সপ্তাহ ০ | শুরুর আগে শুরু
59 recorded video on Python

সপ্তাহ ১ | APIs, File Handling, and Data Manipulation
...
সপ্তাহ ২ | Math for Machine Learning
...
সপ্তাহ ৩ | Development Tools and Best Practices
...
সপ্তাহ ৪ | Regression Models and Evaluation
...
সপ্তাহ ৫ | Classification Models and Evaluation
...
সপ্তাহ ৬ | Unsupervised Learning and Dimensionality Reduction
...
সপ্তাহ ৭ | Introduction to Deep Learning
...
সপ্তাহ ৮ | Computer Vision with CNNs
...
সপ্তাহ ৯ | Recurrent Neural Networks and Time-Series Forecasting
...
সপ্তাহ ১০ | Model Deployment & Monitoring with FastAPI, Docker and MLflo
...
সপ্তাহ ১১ | Natural Language Processing Fundamentals
...
সপ্তাহ ১২ | Transformers and Hugging Face Models
...
সপ্তাহ ১৩ | Prompt Engineering and GPT APIs
...
সপ্তাহ ১৪ | Introduction to LangChain
...
সপ্তাহ ১৫ | Building Intelligent Tool-Integrated Applications
...
সপ্তাহ ১৬ | Multi-Agent Systems and Workflow Automation
...
সপ্তাহ ১৭ | Retrieval-Augmented Generation and Vector Databases
...
সপ্তাহ ১৮ | Capstone Presentation and Career Support
